#!/bin/sh
# Copyright (c) 2017-2019 The worldwideweb Core developers
...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the worldwideweb repository."
  exit 1
fi
...
# See https://github.com/worldwideweb/worldwideweb/issues/16064
...
echo 'When compiling worldwidewebd, run `./configure` in the following way:'
echo
