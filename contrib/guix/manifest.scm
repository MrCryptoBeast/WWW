...
(define* (make-worldwideweb-cross-toolchain target
                                       #:key
...
desirable for building worldwideweb Core release binaries."
...
(define glibc-2.27/worldwideweb-patched
    ...
    (cond ((string-suffix? "-mingw32" target)
          ...
          ((string-contains target "-linux-")
           (list (cond ((string-contains target "riscv64-")
                        (make-worldwideweb-cross-toolchain target
                                                      #:base-libc glibc-2.27/worldwideweb-patched
