...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef worldwideweb_CHAINPARAMSSEEDS_H\n')
    g.write('#define worldwideweb_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the worldwideweb network\n')
    ...
    g.write('#endif // worldwideweb_CHAINPARAMSSEEDS_H\n')
