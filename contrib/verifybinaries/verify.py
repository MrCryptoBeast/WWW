...
"""Script for verifying worldwideweb Core release binaries

This script attempts to download the signature file SHA256SUMS.asc from
worldwidewebcore.org and worldwideweb.org and compares them.
...
WORKINGDIR = "/tmp/worldwideweb_verify_binaries"
HASHFILE = "hashes.tmp"
HOST1 = "https://worldwidewebcore.org"
HOST2 = "https://worldwideweb.org"
VERSIONPREFIX = "worldwideweb-core-"
...
def main(args):
    ...
    if not success:
        print("worldwideweb.org failed to provide signature file, "
              "but worldwidewebcore.org did?")
        print("wget output:")
        print(indent(output, '\t'))
    ...
    if not files_are_equal(sigfile1, sigfile2):
        print("worldwideweb.org and worldwidewebcore.org signature files were not equal?")
    ...
    if retval != 0:
        if retval == 1:
            ...
            print("gpg error. Do you have the worldwideweb Core binary release "
