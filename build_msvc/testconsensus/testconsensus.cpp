...
// worldwideweb includes.
#include <..\src\script\worldwidewebconsensus.h>
...
int main()
{
    std::cout << "worldwidewebconsensus version: " << worldwidewebconsensus_version() << std::endl;
    ...
    auto op0Result = worldwidewebconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, stream.data(), stream.size(), 0, worldwidewebconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
