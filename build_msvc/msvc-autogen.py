#!/usr/bin/env python3
# Copyright (c) 2016-2019 The worldwideweb Core developers
...
libs = [
    'libworldwideweb_cli',
    'libworldwideweb_common',
    'libworldwideweb_crypto',
    'libworldwideweb_server',
    'libworldwideweb_util',
    'libworldwideweb_wallet_tool',
    'libworldwideweb_wallet',
    'libworldwideweb_zmq',
    'bench_worldwideweb',
    'libtest_util',
]
...
def main():
    parser = argparse.ArgumentParser(description='worldwideweb-core msbuild configuration initialiser.')
        ...
        with open(vcxproj_filename + '.in', 'r', encoding='utf-8') as vcxproj_in_file:
            with open(vcxproj_filename, 'w', encoding='utf-8') as vcxproj_file:
                vcxproj_file.write(vcxproj_in_file.read().replace(
                    '@SOURCE_FILES@\n', content))
    copyfile(os.path.join(SOURCE_DIR,'../build_msvc/worldwideweb_config.h'), os.path.join(SOURCE_DIR, 'config/worldwideweb-config.h'))
