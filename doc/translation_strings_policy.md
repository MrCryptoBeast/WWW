...
This document provides guidelines for internationalization of the worldwideweb Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `worldwideweb_en.ts` remains unchanged.
