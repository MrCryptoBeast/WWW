worldwideweb Core version *0.15.2* is now available from:

  <https://worldwidewebcore.org/bin/worldwideweb-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in worldwideweb-tx (TheBlueMatt)
