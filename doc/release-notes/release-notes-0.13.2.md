worldwideweb Core version 0.13.2 is now available from:

  <https://worldwideweb.org/bin/worldwideweb-core-0.13.2/>
...
- #8908 `4a974b2` Update worldwideweb-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow worldwideweb-tx to create v2 transactions (btcdrak)
