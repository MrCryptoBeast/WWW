worldwideweb-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/worldwideweb/files/worldwideweb/worldwideweb-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the worldwideweb
...
New/changed settings (command-line or worldwideweb.conf file)
--------------------------------------------------------
