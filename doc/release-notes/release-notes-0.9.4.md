worldwideweb Core version 0.9.4 is now available from:

  https://worldwideweb.org/bin/0.9.4/
...
this update is incompatible with the worldwideweb system and could lead to consensus
forks.

worldwideweb Core released binaries from https://worldwideweb.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~worldwideweb/+archive/ubuntu/worldwideweb
- A third-party or self-compiled worldwideweb Core

upgrade to worldwideweb Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
