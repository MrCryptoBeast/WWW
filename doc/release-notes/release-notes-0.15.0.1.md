worldwideweb Core version *0.15.0.1* is now available from:

  <https://worldwideweb.org/bin/worldwideweb-core-0.15.0.1/>

and

  <https://worldwidewebcore.org/bin/worldwideweb-core-0.15.0.1/>
