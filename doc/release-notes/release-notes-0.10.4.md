worldwideweb Core version 0.10.4 is now available from:

  <https://worldwideweb.org/bin/worldwideweb-core-0.10.4/>
...
- #6953 `43c2789` Split worldwideweb-tx into its own package
- #6953 `dfe0d4d` Include worldwideweb-tx binary on Debian/Ubuntu
