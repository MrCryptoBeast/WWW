worldwideweb version 0.5.4 is now available for download at:
http://sourceforge.net/projects/worldwideweb/files/worldwideweb/worldwideweb-0.5.4/
...
http://gitorious.org/worldwideweb/worldwidewebd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix worldwideweb-Qt notifications under Growl 1.3.
Increase required age of worldwideweb-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxworldwideweb properly when installing worldwideweb-Qt over it. (Windows)
