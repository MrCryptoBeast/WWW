...
worldwideweb Core version 0.19.1 is now available from:

  <https://worldwidewebcore.org/bin/worldwideweb-core-0.19.1/>
...
From worldwideweb Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as worldwideweb Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, worldwideweb Core does not yet change appearance when
...
- #17488 fix "worldwidewebd already running" warnings on macOS (fanquake)
