worldwideweb Core version 0.16.1 is now available from:

  <https://worldwidewebcore.org/bin/worldwideweb-core-0.16.1/>
...
- #12843 `df38b13` Test starting worldwidewebd with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure worldwidewebd processes are cleaned up when tests end (sdaftuar)
