...
#ifndef worldwideweb_COMPAT_ASSUMPTIONS_H
#define worldwideweb_COMPAT_ASSUMPTIONS_H
...
#if defined(NDEBUG)
# error "worldwideweb cannot be compiled without assertions."
#endif
...
#endif // worldwideweb_COMPAT_ASSUMPTIONS_H
