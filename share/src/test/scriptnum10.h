...
#ifndef worldwideweb_TEST_SCRIPTNUM10_H
#define worldwideweb_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from worldwideweb Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // worldwideweb_TEST_BIGNUM_H
