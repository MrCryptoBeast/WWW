...
{
    BOOST_CHECK(TestSplitHost("www.worldwidewebcore.org", "www.worldwidewebcore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.worldwidewebcore.org]", "www.worldwidewebcore.org", 0));
    BOOST_CHECK(TestSplitHost("www.worldwidewebcore.org:80", "www.worldwidewebcore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.worldwidewebcore.org]:80", "www.worldwidewebcore.org", 80));
