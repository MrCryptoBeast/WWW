...
#ifndef worldwideweb_INTERFACES_NODE_H
#define worldwideweb_INTERFACES_NODE_H
...
//! Top-level interface for a worldwideweb node (worldwidewebd process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // worldwideweb_INTERFACES_NODE_H
