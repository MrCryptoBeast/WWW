...
#ifndef worldwideweb_INTERFACES_INIT_H
#define worldwideweb_INTERFACES_INIT_H
...
//! (worldwideweb-gui, worldwideweb-node, worldwideweb-wallet, worldwidewebd, worldwideweb-qt) and each
...
#endif // worldwideweb_INTERFACES_INIT_H
