...
#ifndef worldwideweb_QT_WALLETMODEL_H
#define worldwideweb_QT_WALLETMODEL_H
...
/** Interface to worldwideweb wallet from Qt view code. */
...
#endif // worldwideweb_QT_WALLETMODEL_H
