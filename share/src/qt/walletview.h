...
#ifndef worldwideweb_QT_WALLETVIEW_H
#define worldwideweb_QT_WALLETVIEW_H
...
private:
    ...
    //!
    //! The wallet model represents a worldwideweb wallet, and offers access to
...
#endif // worldwideweb_QT_WALLETVIEW_H
