    ...
    platformStyle(_platformStyle)
{
    ...
    // normal worldwideweb address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying worldwideweb address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &worldwidewebAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
