...
#ifndef worldwideweb_QT_SENDCOINSDIALOG_H
#define worldwideweb_QT_SENDCOINSDIALOG_H
...
/** Dialog for sending worldwidewebs */
...
#endif // worldwideweb_QT_SENDCOINSDIALOG_H
