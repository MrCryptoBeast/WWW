    ...
    mapper(nullptr)
{
    ...
    ui->worldwidewebAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->worldwidewebAtStartup);
    ...
    ui->worldwidewebAtStartup->setToolTip(ui->worldwidewebAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->worldwidewebAtStartup->setText(ui->worldwidewebAtStartup->text().arg(PACKAGE_NAME));

    ui->openworldwidewebConfButton->setToolTip(ui->openworldwidewebConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new worldwidewebUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->worldwidewebAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openworldwidewebConfButton_clicked()
{
    ...
    if (!GUIUtil::openworldwidewebConf())
