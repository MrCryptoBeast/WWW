...
//! Entry point for worldwidewebApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &worldwidewebApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for worldwidewebGUI tests.
void AppTests::guiTests(worldwidewebGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &worldwidewebGUI::consoleShown, this, &AppTests::consoleTests);
