// Copyright (c) 2018-2021 The worldwideweb Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef worldwideweb_EXTERNAL_SIGNER_H
#define worldwideweb_EXTERNAL_SIGNER_H
...
private:
    ...
    //! worldwideweb mainnet, testnet, etc
    std::string m_chain;
...
#endif // worldwideweb_EXTERNAL_SIGNER_H
