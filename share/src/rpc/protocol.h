...
// Copyright (c) 2009-2019 The worldwideweb Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef worldwideweb_RPC_PROTOCOL_H
#define worldwideweb_RPC_PROTOCOL_H
...
enum RPCErrorCode
{
    ...
    // RPC_INTERNAL_ERROR should only be used for genuine errors in worldwidewebd
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //!< worldwideweb is not connected
...
#endif // worldwideweb_RPC_PROTOCOL_H
