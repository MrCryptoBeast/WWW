...
#ifndef worldwideweb_IPC_PROCESS_H
#define worldwideweb_IPC_PROCESS_H
...
//! IPC process interface for spawning worldwideweb processes and serving requests
...
#endif // worldwideweb_IPC_PROCESS_H
