...
#ifndef worldwideweb_CRYPTO_CHACHA_POLY_AEAD_H
#define worldwideweb_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@worldwideweb.
 *
 ...
 *
 * The chacha20-poly1305@worldwideweb combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@worldwideweb cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@worldwideweb are relatively fast in
...
#endif // worldwideweb_CRYPTO_CHACHA_POLY_AEAD_H
