...
#ifndef worldwideweb_UTIL_MESSAGE_H
#define worldwideweb_UTIL_MESSAGE_H
 ...
 * @param[in] address Signer's worldwideweb address, it must refer to a public key.
...
#endif // worldwideweb_UTIL_MESSAGE_H
