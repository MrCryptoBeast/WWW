...
#ifndef worldwideweb_UTIL_SYSCALL_SANDBOX_H
#define worldwideweb_UTIL_SYSCALL_SANDBOX_H
...
//!
//! SetupSyscallSandbox(...) is called during worldwidewebd initialization if worldwideweb Core was compiled
...
#endif // worldwideweb_UTIL_SYSCALL_SANDBOX_H
