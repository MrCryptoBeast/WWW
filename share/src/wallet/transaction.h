...
#ifndef worldwideweb_WALLET_TRANSACTION_H
#define worldwideweb_WALLET_TRANSACTION_H
...
public:
     ...
     * on this worldwideweb node, and set to 0 for transactions that were created
...
#endif // worldwideweb_WALLET_TRANSACTION_H
