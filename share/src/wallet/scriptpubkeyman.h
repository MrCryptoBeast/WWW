...
#ifndef worldwideweb_WALLET_SCRIPTPUBKEYMAN_H
#define worldwideweb_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The worldwideweb Core wallet was originally a collection of unrelated private
...
#endif // worldwideweb_WALLET_SCRIPTPUBKEYMAN_H
