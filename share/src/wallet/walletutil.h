...
#ifndef worldwideweb_WALLET_WALLETUTIL_H
#define worldwideweb_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! worldwideweb from opening the wallet, thinking it was newly created, and
...
#endif // worldwideweb_WALLET_WALLETUTIL_H
