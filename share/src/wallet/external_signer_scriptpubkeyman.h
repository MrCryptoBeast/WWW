...
#ifndef worldwideweb_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define worldwideweb_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // worldwideweb_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
