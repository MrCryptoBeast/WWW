...
#ifndef worldwideweb_SCRIPT_SCRIPT_H
#define worldwideweb_SCRIPT_SCRIPT_H
...
public:
    ...
    /**
     * Pre-version-0.6, worldwideweb always counted CHECKMULTISIGs
...
#endif // worldwideweb_SCRIPT_SCRIPT_H
