// Copyright (c) 2015-2018 The worldwideweb Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef worldwideweb_CORE_MEMUSAGE_H
#define worldwideweb_CORE_MEMUSAGE_H
...
#endif // worldwideweb_CORE_MEMUSAGE_H
