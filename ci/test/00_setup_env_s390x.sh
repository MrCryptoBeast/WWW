...
export TEST_RUNNER_EXTRA="--exclude rpc_bind,feature_bind_extra"  # Excluded for now, see https://github.com/worldwideweb/worldwideweb/issues/17765#issuecomment-602068547
export RUN_FUNCTIONAL_TESTS=true
export GOAL="install"
export worldwideweb_CONFIG="--enable-reduce-exports --with-incompatible-bdb"
