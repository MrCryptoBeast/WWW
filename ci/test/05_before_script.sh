...
if [ "$CI_OS_NAME" == "macos" ]; then
  echo > $HOME/Library/Application\ Support/worldwideweb
else
  DOCKER_EXEC echo \> \$HOME/.worldwideweb
fi
...
if [[ ${USE_MEMORY_SANITIZER} == "true" ]]; then
  ...
  # from depends. See https://github.com/worldwideweb/worldwideweb/pull/18288#discussion_r433189350 for
  # details.
