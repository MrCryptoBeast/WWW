...
# TestP2PConn: A peer we use to send messages to worldwidewebd, and store responses.
...
class CompactBlocksTest(worldwidewebTestFramework):
    ...
    # This test actually causes worldwidewebd to (reasonably!) disconnect us, so do this last.
    ...
    # worldwidewebd's choice of nonce.
    ...
    # Test that worldwidewebd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, test_node):
        ...
        # Note that it's possible for worldwidewebd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, test_node):
        version = test_node.cmpct_version
        node = self.nodes[0]
        # worldwidewebd will not send blocktxn responses for blocks whose height is
