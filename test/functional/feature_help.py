...
"""Verify that starting worldwideweb with -h works as expected."""

from test_framework.test_framework import worldwidewebTestFramework
from test_framework.util import assert_equal

class HelpTest(worldwidewebTestFramework):
    ...
    def run_test(self):
        self.log.info("Start worldwideweb with -h for help text")
        ...
        self.log.info("Start worldwideweb with -version for version information")
        ...
        self.log.info("Start worldwidewebd with -fakearg to make sure it does not start")
