...
By default, worldwidewebd will dump mempool on shutdown and
...
class MempoolPersistTest(worldwidewebTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent worldwidewebd from writing mempool.dat to disk. Verify that `savemempool` fails")
