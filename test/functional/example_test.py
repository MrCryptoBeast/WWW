...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the worldwidewebTestFramework
    pass


class ExampleTest(worldwidewebTestFramework):
    # Each functional test is a subclass of the worldwidewebTestFramework class.
    ...
    def custom_method(self):
        ...
        worldwidewebTestFramework class so other tests can use it."""
