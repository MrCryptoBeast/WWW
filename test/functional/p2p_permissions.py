...
class P2PPermissionsTests(worldwidewebTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].worldwidewebconf, encoding="utf8") as f:
            newText = f.read().replace(old, new)
        with open(self.nodes[nodeid].worldwidewebconf, 'w', encoding="utf8") as f:
            f.write(newText)
