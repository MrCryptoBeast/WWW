...
class TestShell:
    """Wrapper Class for worldwidewebTestFramework.

    The TestShell class extends the worldwidewebTestFramework
    ...
    class __TestShell(worldwidewebTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by worldwidewebTestFramework child class.
            self.num_nodes = 1
